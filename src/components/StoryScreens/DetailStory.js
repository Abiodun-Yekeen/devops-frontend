...
const DetailStory = () => {
  ...
  useEffect(() => {
    ...
    const getDetailStory = async () => {
      ...
      try {
        const { data } = await axiosInstance.post(`/story/${slug}`, { activeUser })
        setStory(data.data)
  ...
  const handleLike = async () => {
    ...
    try {
      const { data } = await axiosInstance.post(`/story/${slug}/like`, { activeUser }, {
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("authToken")}`,
        },
  ...
  const addStoryToReadList = async () => {
    ...
    try {
      ...
      const { data } = await axiosInstance.post(`/user/${slug}/addStoryToReadList`, { activeUser }, {
        headers: {
          "Content-Type": "application/json",
          authorization: `Bearer ${localStorage.getItem("authToken")}`,
        },
            ...
            <div className='Inclusive-detailStory-page'>
              ...
              <div className='story-content' >
                ...
                <div className="story-banner-img">
                  <img src={`http://3.88.210.223:8085/storyImages/${story.image}`} alt={story.title} />
